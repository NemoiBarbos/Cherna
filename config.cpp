...
class CfgWorlds
{
	...
	class ChernarusPlus: CAWorld
	{
		...
		description="Chernarus Plus";
		worldName="\ChernarusPlus\ChernarusPlus.wrp";
		pictureMap="ChernarusPlus\data\chernarus.paa";
		pictureShot="\ChernarusPlus\data\ui_selectisland_ChernarusPlus_ca.paa";
		startDate="08/03/2020";
		longitude=30;
		latitude=-45;
		centerPosition[]={7100,7750};
		clutterGrid=1.3;
		clutterDist=100;
		noDetailDist=65;
		fullDetailDist=10;
		...
		midDetailTexture="ChernarusPlus\data\middle_mco.paa";
		loadingTexts[]={};
		ilsPosition[]={4887.5,9660};
		ilsDirection[]={0.50749999,0.079999998,-0.86159998};
		ilsTaxiIn[]={4785.21,10174.29,5024.9028,9759.0713,5027.3848,9737.0215,5015.3271,9721.1357,4928.958,9670.5088,4906.105,9664.3721,4880.936,9673.6504};
		ilsTaxiOff[]={4671,10038,4195.5,10862.011,4201.0098,10885.8,4218.5361,10899.822,4304.6792,10950.154,4324.9619,10953.66,4345.7461,10938.886,4785.21,10174.29};
		drawTaxiway=1;
		...
		class Names
		{
			...
			class LOCAL_BASHNYA
			{
				name="$STR_LOCATION_BASHNYA";
				position[]={3993.79,11760.9};
				type="NameLocal";
				radiusA=106.94;
				radiusB=100;
				angle=0;
			};
			class AStrong_Bashnya_01
			{
				name="";
				position[]={4048.5,11627.63};
				type="StrongpointArea";
				radiusA=100;
				radiusB=100;
				angle=195;
			};
			class AStrong_Bashnya_02
			{
				name="";
				position[]={4144.0801,11767.15};
				type="StrongpointArea";
				radiusA=100;
				radiusB=100;
				angle=60;
			};
			class AStrong_Bashnya_03
			{
				name="";
				position[]={4031.27,11889.07};
				type="StrongpointArea";
				radiusA=100;
				radiusB=100;
				angle=30;
			...
			{
				name="";
				position[]={997.34003,9698.0703};
				type="VegetationFir";
				radiusA=300;
				radiusB=328.44;
				angle=0;
			};
			class Local_Crown_Castle
			{
				name="Krona";
				position[]={1409.11,9280.7695};
				type="NameLocal";
				radiusA=200;
				radiusB=200;
				angle=0;
			...
			{
				name="Bogtyrka";
				position[]={1601.5601,8971.4502};
				type="NameVillage";
				radiusA=208.49001;
				radiusB=200;
				angle=0;
			};
			class loc_Lumberyard
			{
				name="Lumberyard";
				position[]={1007.59,7573.3101};
				type="NameLocal";
				radiusA=170;
				radiusB=170;
				angle=0;
			...
			{
				name="Vavilovo";
				position[]={2339.0801,11014.46};
				type="NameVillage";
				radiusA=100;
				radiusB=100;
				angle=0;
			};
			class ACityC_Vavilovo
			{
				name="";
				position[]={2211.28,11056.79};
				type="CityCenter";
				radiusA=100;
				radiusB=100;
				angle=0;
			};
			class AFlatCS_Vavilovo_01
			{
				name="";
				position[]={2315.3401,11159.75};
				type="FlatAreaCitySmall";
				radiusA=100;
				radiusB=100;
				angle=322.88901;
			};
			class AStrong_Vavilovo_01
			{
				name="";
				position[]={2179.79,10616.91};
				type="StrongpointArea";
				radiusA=100;
				radiusB=100;
				angle=204.509;
			};
			class AStrong_Vavilovo_02
			{
				name="";
				position[]={2174.99,11283.39};
				type="StrongpointArea";
				radiusA=100;
				radiusB=100;
				angle=302.03101;
			};
			class AFlatCS_Vavilovo_02
			{
				name="";
				position[]={2217.3601,10928.5};
				type="FlatAreaCitySmall";
				radiusA=100;
				radiusB=100;
				angle=170.56599;
			};
			class AFlatCS_Vavilovo_03
			{
				name="";
				position[]={2532.5801,10995.43};
				type="FlatAreaCitySmall";
				radiusA=100;
				radiusB=100;
				angle=60.299;
			...
			{
				name="";
				position[]={307.25,6279.9102};
				type="VegetationFir";
				radiusA=100;
				radiusB=100;
				angle=0;
			};
			class Loc_Pavlovo_Farm
			{
				name="Farm";
				position[]={1334.89,4072.97};
				type="NameLocal";
				radiusA=100;
				radiusB=100;
				angle=0;
			...
			{
				name="Zabolotye";
				position[]={1171.34,10032.96};
				type="NameVillage";
				radiusA=150;
				radiusB=150;
				angle=0;
			};
			class Loc_Zabolotye_Farm
			{
				name="Farm";
				position[]={1573.08,10447.79};
				type="NameLocal";
				radiusA=100;
				radiusB=100;
				angle=0;
			...
			{
				name="Mayak";
				position[]={12323.81,4553.1099};
				type="Hill";
				radiusA=100;
				radiusB=100;
				angle=0;
			};
			class AStrong_Sinystok_01
			{
				name="";
				position[]={1689.38,12004.03};
				type="StrongpointArea";
				radiusA=100;
				radiusB=100;
				angle=74.934998;
			};
			class AStrong_Topolniki_01
			{
				name="";
				position[]={2774.1399,12297.73};
				type="StrongpointArea";
				radiusA=100;
				radiusB=100;
				angle=222.481;
			};
			class AStrong_Novaya_01
			{
				name="";
				position[]={3799.3301,13140.62};
				type="StrongpointArea";
				radiusA=100;
				radiusB=100;
				angle=77.317001;
			...
			class Loc_Novaya
			{
				name="Novaya Railyard";
				position[]={3534.4299,12537.09};
				type="NameLocal";
				radiusA=100;
				radiusB=100;
				angle=0;
			};
			class City_NovayaPetrovka
			{
				name="Novaya Petrovka";
				position[]={3477.1699,12931.24};
				type="NameCity";
				radiusA=100;
				radiusB=100;
				angle=0;
			...
			class AFlatCS_Sinystok_01
			{
				name="";
				position[]={1372.02,11967.47};
				type="FlatAreaCitySmall";
				radiusA=100;
				radiusB=100;
				angle=0;
			};
			class AFlatCS_Topolniki_01
			{
				name="";
				position[]={3054.1201,12397.08};
				type="FlatAreaCitySmall";
				radiusA=100;
				radiusB=100;
				angle=0;
			};
			class AStrong_Topolniki_02
			{
				name="";
				position[]={3130.5,12632.27};
				type="StrongpointArea";
				radiusA=100;
				radiusB=100;
				angle=42.141998;
			};
			class AStrong_Novaya_02
			{
				name="";
				position[]={3371.6101,12798.6};
				type="StrongpointArea";
				radiusA=100;
				radiusB=100;
				angle=230.761;
			};
			class AStrong_Novaya_03
			{
				name="";
				position[]={3298.1101,13248.29};
				type="StrongpointArea";
				radiusA=100;
				radiusB=100;
				angle=337.03601;
			};
			class Loc_Sinystok_Sawmill
			{
				name="Sawmill";
				position[]={2053,12180.11};
				type="NameLocal";
				radiusA=106.75;
				radiusB=68.879997;
				angle=0;
			};
			class Loc_Zelenogorsk_Rail
			{
				name="Zelenogorsk Railyard";
				position[]={2337.3201,5231.52};
				type="NameLocal";
				radiusA=200;
				radiusB=200;
				angle=0;
			};
			class Settlement_Zaprudnoe
			{
				name="Zaprudnoe";
				position[]={5293.8398,12715.71};
				type="NameVillage";
				radiusA=200;
				radiusB=200;
				angle=0;
			...
			{
				name="";
				position[]={2990.8899,14035.43};
				type="VegetationBroadleaf";
				radiusA=100;
				radiusB=100;
				angle=0;
			};
			class Loc_Zaprudnoe_Farm
			{
				name="Farm";
				position[]={4988.8501,13096.9};
				type="NameLocal";
				radiusA=100;
				radiusB=100;
				angle=0;
		...
		{
			satellite="ChernarusPlus\data\s_satout_co.paa";
...
class CfgSurfaceCharacters
{
	class cp_grass
	{
		probability[]={0.15,0.05,0.7,0.1};
		names[]={"Anthoxanthum","Hypericum","ElytrigiaGreen","ElytrigiaTall"};
	};
	class cp_grass_tall
	{
		probability[]={0.05,0.15,0.5,0.3};
		names[]={"Carduus","Hypericum","Elytrigia","ElytrigiaTall"};
	};
	class cp_broadleaf_sparse1
	{
		probability[]={0.025,0.025,0.1,0.1,0.15,0.02,0.02,0.283,0.166,0.1};
		names[]={"Carduus_f","Hypericum_f","Lolium","Taraxacum","Leafs_spread","Broadleaf_Undergrowth","Broadleaf_Undergrowth_Red","c_Broadleaf_Sprouts","c_Broadleaf_Sprouts_Tall","Twigs_b"};
	};
	class cp_broadleaf_sparse2
	{
		probability[]={0.025,0.25,0.025,0.1,0.15,0.05,0.15,0.1};
		names[]={"Carduus_f","ElytrigiaForest","Hypericum_f","Taraxacum","Polypodiophyta_b","Vaccinium","VacciniumGreen","Twigs_b"};
	};
	class cp_broadleaf_dense1
	{
		probability[]={0.15,0.4,0.01,0.2,0.03,0.1};
		names[]={"Carduus_f","ElytrigiaForest","Taraxacum","Leafs_spread","Broadleaf_Undergrowth","Twigs_b"};
	};
	...
	{
		probability[]={0.1,0.066,0.2,0.3,0.015,0.1};
		names[]={"ElytrigiaForest","Vaccinium","VacciniumGreen","Cones","SmallPicea","Twigs"};
	};
	class cp_conifer_common2
	{
		probability[]={0.1,0.1,0.1,0.25,0.075,0.3,0.015,0.1};
		names[]={"ElytrigiaForest","VacciniumGreen","VacciniumRed","Vaccinium","VacciniumTall","Cones","SmallPicea","Twigs"};
	};
	class cp_conifer_moss1
	{
		probability[]={0.06,0.2,0.05,0.15,0.3,0.015,0.1};
		names[]={"ElytrigiaForest","Vaccinium","VacciniumGreen","VacciniumTall","Cones","SmallPicea","Twigs"};
	};
	class cp_conifer_moss2
	{
		probability[]={0.03,0.1,0.025,0.025,0.05,0.2,0.01,0.1};
		names[]={"ElytrigiaForest","Hypericum","Lolium","Broadleaf_Undergrowth","PolypodiophytaTall","Vaccinium","Cones","Twigs"};
	};
	class cp_concrete_grass
	{
		probability[]={0.025,0.1};
		names[]={"ElytrigiaDirt","ConcreteGrass"};
	};
	class cp_dirt_grass
	{
		probability[]={0.02,0.01,0.175};
		names[]={"ElytrigiaDirt","Taraxacum","DirtGrass"};
	};
};
class CfgSurfaces
{
	...
	class BaseSurface: Default
	{
		access=2;
	};
	class cp_concrete1: BaseSurface
	{
		files="cp_concrete1*";
	...
	class cp_concrete2: BaseSurface
	{
		files="cp_concrete2*";
		soundEnviron="concrete";
		soundHit="concrete";
	...
	class cp_broadleaf_dense1: BaseSurface
	{
	...
	class cp_conifer_common1: BaseSurface
	{
	...
	class cp_grass_tall: BaseSurface
	{
		files="cp_grass_tall*";
		soundEnviron="grass";
		soundHit="soft_ground";
	...
	class cp_gravel: BaseSurface
	{
		...
		surfaceFriction=0.89999998;
		restitution=0.1;
		maxSpeedCoef=0.80000001;
		maxClutterColoringCoef=1.35;
	};
	class cp_rock: BaseSurface
	{
		files="cp_rock*";
		character="Empty";
		soundEnviron="rock";
